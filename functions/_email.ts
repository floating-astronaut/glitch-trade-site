...
export const BRAND: BrandTheme = {
  name:         'Glitch Trade',
  siteUrl:      'https://trade.glitchexecutor.com',
  tagline:      'A 9-model AI ensemble licensed to trading operators.',
  accent:       '#f59e0b',
  accentInk:    '#3a2100',
  supportEmail: 'support@glitchexecutor.com',
  mascotUrl:    'https://trade.glitchexecutor.com/assets/brand/mascot-256.png',
};
